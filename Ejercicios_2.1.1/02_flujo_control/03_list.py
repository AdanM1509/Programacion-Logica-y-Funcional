...
# Utilizando slicing y concatenacion, crea una nueva lista que contenga solo el mensaje "secreto".

mensaje = ["C", "o", "d", "i", "g", "o", " ", "s", "e", "c", "r", "e", "t", "o"]

# Tomamos solo la parte de "secreto" usando slicing
secreto = mensaje[7:]
...
# Intercambiamos primera y última posición
...
# Dada una lista con un numero impar de elementos, extrae el elemento que se encuentra en el centro de la lista utilizando slicing.
# Ejemplo: lista = [10, 20, 30, 40, 50] -> El centro es 30

lista = [10, 20, 30, 40, 50]

# Calculamos el índice del centro
centro = len(lista) // 2

# Extraemos el elemento central
...
# Invertimos solo la primera mitad
